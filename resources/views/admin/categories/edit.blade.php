...
<div class="bg-white shadow-lg rounded-xl overflow-hidden">
    <div class="bg-gradient-to-r from-gray-800 to-gray-900 px-6 py-4">
        <h3 class="text-white font-semibold text-lg">Edit Kategori: {{ $category->name }}</h3>
    </div>
    <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-6">
                        ...
                        <label class="w-full flex flex-col items-center px-4 py-6 bg-white rounded-lg border border-gray-300 border-dashed cursor-pointer hover:bg-gray-50">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="mt-1 text-sm text-gray-600">
                                    <span class="font-medium text-green-600 hover:underline">Upload gambar baru</span> atau drag and drop
                                </p>
                    ...
                    <div id="image-preview" class="mt-2 {{ $category->image ? '' : 'hidden' }}">
                        <div class="relative">
                            <img id="preview-img" class="h-32 w-32 object-cover rounded-lg"
