<x-app-layout>
    ...
    <div class="bg-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14">
                <span class="bg-yellow-100 text-yellow-800 text-xs font-semibold px-3 py-1 uppercase rounded-full">Kategori Kami</span>
                <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl mt-3">Temukan Sesuai Kebutuhan</h2>
                <div class="w-24 h-1 bg-green-600 mx-auto mt-5 rounded-full"></div>
                <p class="mt-5 text-lg text-gray-600 max-w-3xl mx-auto">Berbagai kategori pakan ternak yang tersedia untuk memenuhi kebutuhan ternak Anda</p>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                @foreach($categories as $category)
                    <a href="{{ route('shop.products.index', ['category' => $category->slug]) }}"
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-8 text-center border border-green-100 transition-all duration-300 group-hover:border-green-300 group-hover:shadow-md transform group-hover:-translate-y-1">
                            <div class="bg-white rounded-full w-16 h-16 mx-auto flex items-center justify-center mb-4 shadow-sm group-hover:shadow group-hover:bg-green-50 transition-all duration-300">
                                @switch($category->name)
                                    @case('Pakan Ayam')
                                        <i class="fas fa-drumstick-bite text-2xl text-yellow-600"></i>
                                        @break
                                    @case('Pakan Sapi')
                                        <i class="fas fa-cow text-2xl text-yellow-800"></i>
                                        @break
                                    @case('Pakan Ikan')
                            ...
                            <h3 class="font-bold text-lg text-gray-900 group-hover:text-green-700 transition-colors">{{ $category->name }}</h3>
                            <p class="text-sm text-gray-500 mt-2">Lihat produk</p>
                            <div class="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <i class="fas fa-arrow-circle-right text-green-600"></i>
                            </div>
                        </div>
                    </a>
                @endforeach
    ...
    <div class="bg-gradient-to-br from-green-50 to-green-100 py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14">
                <span class="bg-green-100 text-green-800 text-xs font-semibold px-3 py-1 uppercase rounded-full">Testimoni</span>
                <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl mt-3">Kepuasan Pelanggan</h2>
                <div class="w-24 h-1 bg-yellow-500 mx-auto mt-5 rounded-full"></div>
                <p class="mt-5 text-lg text-gray-600 max-w-3xl mx-auto">Apa yang pelanggan kami katakan tentang produk kami</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-sm p-8 relative">
                    ...
                    <div class="pt-4">
                        <p class="text-gray-600 mb-6">Pakan ayam dari TokoDeden membuat ayam saya tumbuh lebih sehat dan produksi telur meningkat signifikan. Kualitas produk sangat terjaga!</p>
                ...
                <div class="bg-white rounded-xl shadow-sm p-8 relative">
                    ...
                    <div class="pt-4">
                        <p class="text-gray-600 mb-6">Saya sudah berlangganan pakan sapi dari TokoDeden selama 2 tahun. Kualitasnya konsisten dan sapi-sapi saya tumbuh lebih cepat dan sehat.</p>
                        <div class="flex items-center">
                            <div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center text-gray-500">
                                <i class="fas fa-user"></i>
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-8 relative">
                    ...
                    <div class="pt-4">
                        <p class="text-gray-600 mb-6">Pengiriman cepat dan pelayanan sangat baik. Pakan ikan yang saya beli membuat ikan kolam saya tumbuh optimal dan warnanya lebih cerah.</p>
                        <div class="flex items-center">
                            <div class="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center text-gray-500">
                                <i class="fas fa-user"></i>
                            </div>
